...
public abstract class Document {
	...
	{
	    double mainConst = 206.835;
            double wordSentConst = 1.015;
            double syllableWordConst = 84.6;
            double wordSent = getNumWords() / (getNumSentences()*1.0);
            double syllableWord = getNumSyllables()/(getNumWords()*1.0);
            
	    return mainConst - wordSentConst*wordSent - syllableWordConst*syllableWord;
	}
